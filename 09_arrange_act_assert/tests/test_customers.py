...
class TestCustomersDB(unittest.TestCase):
    ...
    def setUp(self):
        ...
        customers_data = [
            ...
            ('Mike', 'Doe', 'mike.doe@mail.com', '222-222', 'USA')
        ]
    ...
    def test_add_customer(self):
        ...
        db.add_customer('Jan', 'Kowalski', 'jan.nowak@mail.com', '444', 'PL')
        ...
        # assert
        expected = (
            ('Jan', 'Kowalski', 'jan.kowalski@mail.com', '444', 'PL'),
            ('John', 'Smith', 'john.smith@mail.com', '111', 'USA'),
            ('John', 'Doe', 'john.doe@mail.com', '333', 'USA'),
            ('Mike', 'Doe', 'mike.doe@mail.com', '222-222', 'USA')
        )
    ...
    def test_find_customers_by_country(self):
        ...
        # act
        actual = tuple(db.test_find_customers_by_country('USA'))
